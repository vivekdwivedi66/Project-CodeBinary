				...
				<div class="row">
					...
					<div class="col-md-6 col-md-push-1 animate-box">
						<div class="about-desc">
							<div class="owl-carousel3">
								<div class="item">
									<h2><span>CodeBinary</span><span>Initiatives</span></h2>
								</div>
								<div class="item">
									<h2><span>where Passion meets</span><span>Purpose</span></h2>
								</div>
							</div>
							<div class="desc">
								<div class="rotate">
						...
						<div class="work-entry animate-box">
							<a href="https://kalpanaa.codebinary.in/" target="_blank" class="work-img" style="background-image: url(images/wesp.jpg);">
								<div class="display-t">
									<div class="work-name">
										<h2>Kalpanaa</h2></br>
										<h5>A Women Entrepreneur Support Programme</h5>
									</div>
								</div>
							</a>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="services-flex">
							...
							<div class="one-forth services-img" style="background-image: url(images/community.png);">
							</div>
						</div>
					</div>
				</div>
